    ...
    <footer className="bg-white text-gray-800">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          ...
          <a href="#" className="w-8 h-8 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded flex items-center justify-center">
        ...
        <div className="flex justify-center space-x-6">
          <a href="#" className="w-12 h-12 bg-blue-600 rounded flex items-center justify-center">
            <span className="text-white font-bold text-lg">f</span>
          </a>
          <a href="#" className="w-12 h-12 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded flex items-center justify-center">
