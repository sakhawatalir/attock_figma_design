            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Our team is ready to help you create the perfect signage solution for your business. 
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+971501234567" className="hover:text-green-600 transition-colors">
                        +971 50 123 4567
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@batal.ae" className="hover:text-green-600 transition-colors">
                        info@batal.ae
                      </a>
                    </p>
                  </div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="illuminated">Illuminated Signs</option>
                    <option value="3d-letters">3D Letters</option>
                    <option value="glass-vinyl">Glass & Vinyl</option>
                    <option value="pylon">Pylon & Hoardings</option>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Visit our office in Dubai</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <div className="w-full h-96 bg-gray-200 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">Office 103-466, Hamad M.A Al Bahar, Al Khabeesi - Dubai UAE</p>
              </div>
            </div>
          </div>
        </div>
